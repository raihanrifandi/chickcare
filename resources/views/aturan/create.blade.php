...
@section('contents')
    ...
    <div class="flex justify-between items-center mb-8">
        <div class="p-2 flex items-center flex-wrap">
            <ul class="flex items-center">
              ...
              <li class="inline-flex items-center">
                <a href="{{ route('aturan.create') }}" class="text-gray-600 hover:text-blue-500 font-semibold ">
                  Tambah Data
                </a>
              </li>
    ...
    <div class="bg-white rounded-lg shadow-md container mx-auto px-4 py-8 mb-4">
        ...
        <form action="{{ route('aturan.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="number" name="mb" id="mb" step="0.1" min="0" max="1" class="block w-full p-3 border rounded focus:outline-none focus:ring focus:border-blue-300" placeholder="Masukkan Nilai MB">
                @error('mb')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="md" id="md" step="0.1" min="0" max="1" class="block w-full p-3 border rounded focus:outline-none focus:ring focus:border-blue-300" placeholder="Masukkan Nilai MD">
                @error('md')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
